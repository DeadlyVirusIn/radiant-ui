      ...
      <Section title="Pool" className="mt-6" padded={false}>
        <table className="w-full text-sm">
          <thead><tr className="text-left text-[10px] uppercase tracking-[0.12em] text-muted-foreground">
            <th className="px-5 py-3">ID</th><th className="px-5 py-3">Role</th><th className="px-5 py-3">State</th><th className="px-5 py-3 text-right">Hunts</th><th className="px-5 py-3 text-right"></th>
          </tr></thead>
