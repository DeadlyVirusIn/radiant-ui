...
import { HeartPulse, Bot, Wifi, AlertTriangle } from "lucide-react";
...
function FleetHealth() {
  return (
    <>
      <PageHeader
        title="Fleet health"
        description="Regional bot pools, healthiness and any in-flight alerts. Operational preview — values shown are mock data, not wired to live fleet telemetry."
        actions={<ReadOnlyBadge />}
      />
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <StatCard label="Bots online" value="40 / 42" icon={Bot} tone="success" />
        <StatCard label="Open alerts" value="3"   tone="warning" icon={AlertTriangle} />
